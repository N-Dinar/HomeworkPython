...
# должны быть распечатаны. Нумерация строк и столбцов идет с единицы (подумайте, почему
# не с нуля). Примечание: бинарной операцией называется любая операция, у которой 
...
# перебираем элементы от 1 до 6 (значит, берем от 1 до 7. а может от 2 до 7, 
# чтоб 0 не брать)
# operation - это lambda x, y: x * y
